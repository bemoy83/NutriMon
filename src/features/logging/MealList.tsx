          ...
          {!isFinalized && (
            <>
              <div className="flex border-t" style={{ borderColor: theme ? theme.divider : 'var(--app-border)' }}>
                <button
                  onClick={onEdit}
                  className="flex-1 flex items-center justify-center gap-1.5 py-2.5 text-sm text-[var(--app-brand)] transition-colors hover:bg-[var(--app-hover-overlay)]"
                >
                ...
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-1.5 py-2.5 text-sm text-[var(--app-text-secondary)] transition-colors hover:bg-[var(--app-hover-overlay)] disabled:opacity-40"
                >
                  <svg className="w-3.5 h-3.5 flex-none" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                ...
                <button
                  onClick={onDelete}
                  disabled={deleting}
                  className="flex-1 flex items-center justify-center gap-1.5 py-2.5 text-sm text-[var(--app-danger)] transition-colors hover:bg-[var(--app-hover-overlay)] disabled:opacity-40"
                >
                  <svg className="w-3.5 h-3.5 flex-none" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
