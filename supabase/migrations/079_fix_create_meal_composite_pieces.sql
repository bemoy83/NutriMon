-- 079_fix_create_meal_composite_pieces.sql
--
-- The 6-arg create_meal_with_items function on remote was not updated by
-- migrations 038/041/042 (those were repaired/marked applied without running).
-- Re-apply the full 042 version which adds composite quantity mode support
-- (pieces branch) and per-100g nutrition snapshots for simple products.
